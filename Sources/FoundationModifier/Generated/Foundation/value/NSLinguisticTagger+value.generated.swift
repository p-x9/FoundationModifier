...
extension Modify.DynamicMemberWrap where T: NSLinguisticTagger {
    ...
    public func enumerateTags(in range: Foundation.NSRange, scheme tagScheme: Foundation.NSLinguisticTagScheme, options opts: Foundation.NSLinguisticTagger.Options = [], using block: (Foundation.NSLinguisticTag?, Foundation.NSRange, Foundation.NSRange, Swift.UnsafeMutablePointer<ObjectiveC.ObjCBool>) -> Swift.Void) -> T {
    ...
    public func enumerateTags(in range: Foundation.NSRange, unit: Foundation.NSLinguisticTaggerUnit, scheme: Foundation.NSLinguisticTagScheme, options: Foundation.NSLinguisticTagger.Options = [], using block: (Foundation.NSLinguisticTag?, Foundation.NSRange, Swift.UnsafeMutablePointer<ObjectiveC.ObjCBool>) -> Swift.Void) -> T {
    ...
    @available(macOS, introduced: 10.7, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
    @available(iOS, introduced: 5.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
    public func setOrthography(_ orthography: Foundation.NSOrthography?, range: Foundation.NSRange) -> T {
    ...
    @available(macOS, introduced: 10.7, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
    @available(iOS, introduced: 5.0, deprecated: 100000, message: "All NSLinguisticTagger API should be replaced with NaturalLanguage.framework API")
    public func stringEdited(in newRange: Foundation.NSRange, changeInLength delta: Swift.Int) -> T {
